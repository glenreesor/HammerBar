...
import { buildLineGraphCurrentValueWidget } from './buildLineGraphCurrentValueWidget';

export function getLineGraphCurrentValueBuilder(
  ...
  return {
    ...
    buildWidget: (widgetBuilderParams: WidgetBuilderParams) =>
      buildLineGraphCurrentValueWidget(validParams, widgetBuilderParams),
  };
}
